        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div className="mb-8 p-6 bg-gradient-to-r from-green-100 to-emerald-100 rounded-2xl border-2 border-green-300">
              ...
              <div className="flex justify-center space-x-8 mb-6">
                <div className="text-center p-3 bg-green-50 rounded-lg border-2 border-green-200">
                  <div className="text-4xl mb-2">{team1Environment.forest}</div>
                  <p className="text-sm text-green-600 font-bold">森が元気！</p>
                </div>
              ...
              <div className="bg-white p-4 rounded-xl shadow-md border-2 border-green-200">
                <p className="text-2xl text-green-800 font-bold text-center mb-2">
                  🐄 牛{" "}
                  <span className="text-3xl text-purple-600">{team1Cows}</span>{" "}
                  頭分のCO₂削減！
                </p>
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 border-4 border-red-400">
            ...
            <div className="mb-8 p-6 bg-gradient-to-r from-green-100 to-emerald-100 rounded-2xl border-2 border-green-300">
              ...
              <div className="flex justify-center space-x-8 mb-6">
                <div className="text-center p-3 bg-green-50 rounded-lg border-2 border-green-200">
                  <div className="text-4xl mb-2">{team2Environment.forest}</div>
                  <p className="text-sm text-green-600 font-bold">森が元気！</p>
                </div>
                <div className="text-center p-3 bg-blue-50 rounded-lg border-2 border-blue-200">
              ...
              <div className="bg-white p-4 rounded-xl shadow-md border-2 border-green-200">
                <p className="text-2xl text-green-800 font-bold text-center mb-2">
                  🐄 牛{" "}
                  <span className="text-3xl text-purple-600">{team2Cows}</span>{" "}
                  頭分のCO₂削減！
                </p>
                <p className="text-lg text-green-700 text-center">
                  🌱 地球温暖化をしっかり防止しました
